        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    NomeCerveja = table.Column<string>(nullable: true),
                    Aprovado = table.Column<bool>(nullable: false),
                    DescricaoCerveja = table.Column<string>(nullable: true),
                    GrauAlcoolico = table.Column<float>(nullable: false),
                    TipoCervejaId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cerveja", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Cerveja_TipoCerveja_TipoCervejaId",
